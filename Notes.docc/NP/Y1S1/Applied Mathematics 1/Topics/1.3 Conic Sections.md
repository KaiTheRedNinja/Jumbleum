...
In a conic section, the plane intersects the cone at the same gradient as the cone. This means that the plane never "closes" (like an 
ellipse), but also doesn't "flip" (like a hyperbola).

The eccentricity of a parabola is defined as 1, and hence is always 1.

There's... not much else in the notes.
...
They're apparently not super useful in our course.
