...
### Similarities between Reliability and Utility

- Reliability == trustworthy, credible
- Utility == Useful


## Reliability

Reliability is the basis for utility. 

In General:
- reliable        → useful
- not reliable    → not useful

### (Predicted) Marking Scheme: 
- L3 - just the source is analysed, ie. useful only because the author is talking
- L4 - cross referenced to other sources → reliability, ∴ useful → utility
- L5 - cross referenced to agree and disagree source
- L6 - Higher Level Analysis (HLA) → purpose (hidden agenda), contenxt, tone, provenance, bias [not in any particular order]
- L7 - L4 + HLA

> If you don't trust yourself to do HLA, just do L5 if you have time. 
...
For Purpose as HLA: 
- Provenance explained + supported
- Identity → Message → Purpose 
...
> Identifying Expectancy: 
> - context of source
> - identity of person
> - context affecting what the person is going to say
...
Strategy:
1. Use sources that you are *surprised by*, if there is really nothing then go to not surprised by. 
...
## According to Mr Seah
| Paragraph | Stand | Skill | Marks | 
|:---|---|---|:---:|
| **Para 1** | Stand 1 | Skill 1 | + |
| Para 2 | Stand 1 | Skill 1 | 0 |
| Para 2 | Stand 2 | Skill 1 | + |
| Para 2 | Stand 1 | Skill 2 | + |
| Para 2 | Stand 2 | Skill 2 | 0 |
