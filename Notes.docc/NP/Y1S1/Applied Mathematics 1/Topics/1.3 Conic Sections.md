...
Note that vertices are POINTS. They lie on lines, but they are not the lines themselves. They are the
points of intersection of those lines with the conic section.
